...
public class CommentAnalysisTest {
  ...
  private static final ArrayList<Double> SCOREVALUE_1 =
      new ArrayList<>(Arrays.asList(0.001, 0.002, 0.003, 0.005, -0.1, -0.2));
  private static final ArrayList<Double> SCOREVALUE_2 =
      new ArrayList<>(Arrays.asList(1.0, -1.0, 0.0));
  private static final ArrayList<Double> SCOREVALUE_3 =
      new ArrayList<>(Arrays.asList(0.5, 0.9, -0.5, -0.9));
  private static final ArrayList<Double> SCOREVALUE_4 =
